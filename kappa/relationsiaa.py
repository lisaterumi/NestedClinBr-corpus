...
def main():
    ...
    if len(sys.argv) == 1:
        try:
            ...
            #dir_path_one = r"anotadora1/9348_goldstandard_train.ann"
            #dir_path_two = r"anotadora2/9348_goldstandard_train.ann"
            dir_path_one = r"C:\Users\lisat\OneDrive\jupyter notebook\NestedClinBr-corpus\kappa\anotadora1"
            dir_path_two = r"C:\Users\lisat\OneDrive\jupyter notebook\NestedClinBr-corpus\kappa\anotadora2"
        ...
        try:
            ...
            dir_path_one = "anotadora1"
            dir_path_two = "anotadora2"
            if not os.path.isdir(dir_path_one) or not os.path.isdir(dir_path_two):
                raise NotValidPath
            print('Directories path used:\n\t{}\n\t{}'.format(dir_path_one, dir_path_two))
            print(
...
def main_arg(command, dir_path_one, dir_path_two):
    if command == '-m':
        merge_files(dir_path_one, dir_path_two)
    elif command == '-k':
        iaa_kappa(dir_path_one, dir_path_two)
        ...
        iaa_fscore(dir_path_one, dir_path_two)
    elif command == '-mk' or command == '-km':
        merge_files(dir_path_one, dir_path_two)
        iaa_kappa(dir_path_one, dir_path_two)
    elif command == '-mf' or command == '-fm':
        merge_files(dir_path_one, dir_path_two)
        iaa_fscore(dir_path_one, dir_path_two) 
